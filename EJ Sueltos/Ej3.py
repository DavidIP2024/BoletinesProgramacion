# Programa de gestión de frutas
# - Tupla frutas_fijas: ("manzana", "banana", "naranja") → no se puede modificar
# - Lista frutas_lista: permite añadir, cambiar y borrar frutas
# - Menú con opciones:
#     1. Añadir fruta
#     2. Cambiar fruta
#     3. Borrar fruta
#     4. Mostrar frutas
#     5. Salir
# - Según la opción: el usuario puede modificar la lista
